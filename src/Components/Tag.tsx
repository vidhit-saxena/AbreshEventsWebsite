...
export const Tag = (props: ComponentPropsWithoutRef<'div'> & {color?: string}) => {
    ...
    return (
        <div 
            className={twMerge("px-3 py-1.5 uppercase font-heading font-extrabold tracking-wider text-xs bg-fuchsia-500/15 text-fuchsia-500 inline-flex rounded-full", 
