...
export default function Introduction() {
    ...
    const rotateX = useTransform(scrollYProgress, [0, 1], [29, 0]);
    ...
    return (
        <section className="py-16 lg:py-32 bg-black  ">
            <div className="container">
                ...
                <div className="text-white text-3xl  md:text-5xl lg:text-7xl text-center font-medium mt-10 max-w-6xl mx-auto">
